package com.epam.aleksandr_generalov.java.lesson8;

import com.epam.aleksandr_generalov.java.lesson8.models.Car;
import com.epam.aleksandr_generalov.java.lesson8.models.LightCar;
import com.epam.aleksandr_generalov.java.lesson8.models.WeightCar;
import com.epam.aleksandr_generalov.java.lesson8.utils.CollectionUtils;
import com.epam.aleksandr_generalov.java.lesson8.utils.NegativeNumberException;
import com.epam.aleksandr_generalov.java.lesson8.utils.Serializator;
import com.epam.aleksandr_generalov.java.lesson8.utils.XMLUtils;
...
public class Task9Runner {
    ...
    private static final String lightCar = "com.epam.aleksandr_generalov.java.lesson8.models.LightCar";
    private static final String weightCar = "com.epam.aleksandr_generalov.java.lesson8.models.WeightCar";

    public static void main(String[] args) {
        Task9Runner runner = new Task9Runner();
            ...
            if (lightCars != null && weightCars != null) {
                while (true) {
                    System.out.println("Please enter action: 'add' - add information, 'edit' - edit information, " +
                            ...
                            "'write' - write information about car in file, 'readXML' - read information about car from XML-file, " +
                            "'writeXML' - write information about car in XML, 'exit' - exit from application");
                    ...
                    switch (action) {
                        ...
                        case "readXML":
                            System.out.println("Enter name of file");
                            System.out.println(XMLUtils.readObjectFromXml(scanner.nextLine()));
                            break;
                        case "writeXML":
                            carType = chooseTypeOfCar();
                            if (carType != null && carType.equals(LightCar.class.getName())) {
                                ...
                                System.out.println("Enter name of file");
                                scanner.nextLine();
                                XMLUtils.writeObjectToXml(scanner.nextLine(), lightCars.get(index));
                            } else {
                                System.out.println("Please enter index for weight car:");
                                index = scanner.nextInt();
                                System.out.println("Enter name of file");
                                scanner.nextLine();
                                XMLUtils.writeObjectToXml(scanner.nextLine(), weightCars.get(index));
                            }
                            break;
                        case "exit":
                            return;
